...
const title = 'Trading Agent - Quantitative Analysis Platform'
const description = 'AI-powered quantitative analysis platform for retail investors. It includes a dark mode toggle and is optimized for performance and data efficiency.'
